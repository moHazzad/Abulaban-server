...
router.put('/update/:userId', isAdmin(USER_ROLE.user, USER_ROLE.admin, USER_ROLE.super), userController.updateSingleUserController )
router.get('/:userId',  userController.singleUserById )
